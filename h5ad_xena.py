...
if __name__ == "__main__" and len(sys.argv[:]) not in [4,5,6,7]:
    print "pyton h5ad_xena.py h5_input group_name tsv_output barcode_prefix(optional)\n"
    print "pyton h5ad_xena.py h5_input group_name tsv_output start_list(inclusive) end_list(exlusive) barcode_prefix(optional)\n"
    sys.exit()
